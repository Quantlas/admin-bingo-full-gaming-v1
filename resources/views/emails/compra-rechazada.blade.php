...
<body>
    <div class="container">
        ...
        <div class="content">
            ...
            <p>Lamentamos informarle que no hemos podido confirmar su compra en <strong>Bingo Full Gaming</strong>:</p>

            <div class="card-info">
                Número de serie: <strong>{{ $serial_number }}</strong>
            </div>

            <p>Para mayor información, por favor comuniquese por nuestros canales de soporte.</p>
        ...
        <div class="footer">
            <div class="social-links">
                ...
                {{-- <a href="#"><img src="{{ $message->embed(public_path('images/instagram.png')) }}" alt="Instagram"
                        width="24"></a> --}}
                <a href="#"><img src="{{ $message->embed(public_path('images/whatsapp.png')) }}" alt="WhatsApp"
                        width="24"></a>
            </div>
